...
const initRagicPage = async (config) => {
  ...
  if (canUse('design') && newRecordButton && !document.querySelector('#designTableButton')) {
    newRecordButton.insertAdjacentHTML('beforebegin', '<button class="secondary" id="designTableButton" type="button">⚙️ 設計表格</button>');
  }
